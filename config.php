...
$CFG->dbhost    = 'lovelysunrise-server.mysql.database.azure.com';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'lovelysunrise-database';     // database name, eg moodle
$CFG->dbuser    = 'fsjgdumzqn';   // your database username
$CFG->dbpass    = '63S176W2080T3V72$';   // your database password
...
$CFG->wwwroot   = 'lovelysunrise.azurewebsites.net';
...
$CFG->dataroot  = 'https://lovelysunrisedata.file.core.windows.net/lovelysunrisedata/moodledata';
